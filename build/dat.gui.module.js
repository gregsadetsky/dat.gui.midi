    ...
    navigator.requestMIDIAccess().then(function (access) {
      _this2.__midi = {
        ...
        settings: {
          ...
          selectedInputId: [].concat(toConsumableArray(access.inputs))[0][1].id
        }
      };
      addMidiMenu(_this2);
